  ...
  pillars = [
    {
      ...
      title: "Non-custodial",
      description: "Your assets remain in your wallet. Trade directly from your own keys without giving up control."
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "No KYC Required",
      description: "Access global markets instantly. No identity verification, no waiting periods, no restrictions."
    },
    {
      icon: <Globe className="w-8 h-8" />,
      title: "Fully On-chain",
      description: "Every trade is transparent and verifiable. Built on decentralized infrastructure you can trust."
    }
  ],
